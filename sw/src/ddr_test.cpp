...
int main(int argc, char *argv[]) {
   ...
   uint32_t workGroupSize[32] = {0x10000000,0x10000000,0x10000000,0x10000000,0x10000000,0x10000000,0x10000000,0x10000000,//0,1,2,...,7
                                 ...
                                 0x10000000,0x10000000,0x10000000,0x10000000,0x10000000,0x10000000,0x10000000,0x10000000,
                                 0x10000000,0x10000000,0x10000000,0x10000000,0x10000000,0x10000000,0x10000000,0x10000000};
   uint64_t numOps[32]        = {100000,100000,100000,100000,100000,100000,100000,100000,
                                 100000,100000,100000,100000,100000,100000,100000,100000,
                                 100000,100000,100000,100000,100000,100000,100000,100000,
                                 100000,100000,100000,100000,100000,100000,100000,100000};
   uint32_t strideLength[32]  = {64,64*2,64*4,64*8,64*16,64*32,64*64,64*128,
   ...
   uint32_t read_enable         = 0x1; //0x80000000 
   ...
   for(int i=0;i<CHANNAL_NUM;i++){
      controller->configDDR(workGroupSize[i],numOps[i],strideLength[i],memBurstSize[i],initialAddr[i],i);
   }

   controller->runDDRtest(write_enable, read_enable, latency_test_enable, latency_channel,
   ...
   controller->readDDRData(write_enable,read_enable,latency_test_enable, latency_channel,numOps[latency_channel],memBurstSize);
